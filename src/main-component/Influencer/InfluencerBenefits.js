...
import InfluencerBenefitsPage from "./InfluencerBenefitsPage";
import Navbar from "../../components/Navbar/Navbar";
import PageTitle from "../../components/pagetitle/PageTitle";
import Footer from "../../components/footer/Footer";
import Scrollbar from "../../components/scrollbar/scrollbar";

function InfluencerBenefits({show, setShow, path}) {
  ...
  return (
    <Fragment>
      ...
      <PageTitle pageTitle={"Benefits"} pagesub={"Benefits"} link={"/influencer"} />
      <InfluencerBenefitsPage show={show} setShow={setShow}/>
      <Footer />
      <Scrollbar />
    </Fragment>
  );
