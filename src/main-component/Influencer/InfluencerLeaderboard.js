...
import InfluencerLeaderboardPage from "./InfluencerLeaderboardPage";

function InfluencerLeaderboard({show, setShow, path}) {
  ...
  return (
    <Fragment>
      ...
      <PageTitle pageTitle={"Leaderboard"} pagesub={"Leaderboard"} link={"/influencer"} />
      <InfluencerLeaderboardPage show={show} setShow={setShow}/>
      <Footer />
      <Scrollbar />
    </Fragment>
  );
