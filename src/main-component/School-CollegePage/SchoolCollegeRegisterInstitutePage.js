              ...
              <div className="col-lg-6 col-md-12 col-12">
                <div className="wpo-about-img">
                  <div className="wpo-about-right pt-3">
                    <Image src={Path2} width="auto" height="auto" alt="Inspire Service in Students with Sevak Army" />
                  </div>
                </div>
              </div>
              <div className="col-lg-6 col-md-12 col-12">
              ...
              <div className="col-lg-7 col-md-12 col-12">
                <div className="wpo-about-text p-3 mt-0 pb-1 pb-lg-2 pt-1 pt-lg-2">
                  ...
                  <p className="mt-0 pt-0" style={{ textAlign: "justify" }}>
                    Register your school or college with Sevak Army. With a
              ...
              <div className="col-lg-5 col-md-12 col-12">
                <div className="wpo-about-img d-flex w-100">
                  <div className="wpo-about-right pt-lg-4">
                    ...
                    <Image width={450} src={SignUp} alt="Register & Sign In to Sevak Army" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="section-padding container">
        ...
        <div className="row justify-content-center">
          <div className="col-lg-6 col-md-12 col-12 mt-2">
            <SectionTitle subtitle="Make a Lasting Impact" title="Why Register with Sevak Army?" />
          </div>
        </div>
