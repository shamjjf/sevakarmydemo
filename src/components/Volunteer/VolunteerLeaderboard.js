...
import VolunteerLeaderboardPage from "./VolunteerLeaderboardPage";

function VolunteerLeaderboard({show, setShow, path}) {
  ...
  return (
    <Fragment>
      ...
      <PageTitle pageTitle={"Leaderboard"} pagesub={"Leaderboard"} link={"/volunteer"} />
      <VolunteerLeaderboardPage show={show} setShow={setShow}/>
      <Footer />
      <Scrollbar />
    </Fragment>
  );
